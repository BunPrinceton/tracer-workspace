...
(function () {
    ...
    var INDEX = [
        ...
        },
        {
            ...
            description: "The story of the tracer team's work — a synopsis of every project era with its time span (Pinky/Omni, CREMI, Minnie65/V1DD, FlyWire/FAFB, BANC, CA3, MEC), plus a verbal history of how the work evolved from Omni error-hunting to today.",
            aliases: ["task history", "project history", "team history", "verbal history", "work history", "eras"],
            keywords: ["task history", "history", "timeline", "eras", "synopsis", "narrative", "pinky", "omni", "cremi", "minnie", "v1dd", "flywire", "fafb", "optic lobe", "banc", "brain and nerve cord", "ca3", "mec", "proofreading", "ground truth", "verbal history"],
            text: "task history project history verbal history synopsis eras timeline pinky omni vast semantic ground truth cremi fly minnie65 v1dd microns flywire fafb optic lobe banc brain and nerve cord triage ca3 mec hippocampus zheng zetta webknossos cross-project logs templates tooling proofreading how the work evolved"
        },
        {
            title: 'Dashboard',
            url: '',
        ...
        },
        {
            ...
            url: 'link-restore/',
            section: 'Experimental',
            description: 'Revive old FlyWire / Neuroglancer share links that fail to load. Test ground with several methods: the recommended session-token fix (warm up by opening any scene first), an interactive middleauth+ restorer (paste a dead link / bookmarklet / userscript), and a section for old MICrONS / appspot links (dynamicannotationframework.com/nglstate) whose state-server domain was retired — rewrite the host to global.daf-apis.com/nglstate/api/v1 and open in Spelunker while logged into CAVE.',
            aliases: ['flywire link restorer', 'link restorer', 'flywire links', 'link troubleshooting', 'broken link', 'dead link', 'http error 0', 'flywire not loading', 'segmentation not loading', 'microns links', 'appspot links', 'dynamicannotationframework', 'dead state server'],
